...
public class Server implements Runnable {
    ...
    public void run() {
        ...
        try {
            p.load(new FileInputStream("yakuza.ini"));
        } catch (Exception e) {
            System.out.println("Please start create_server.bat");
            System.exit(0);
        }

        System.out.println("Yakuza v" + ServerConstants.VERSION + " starting up.\r\n");
        ...
        try {
            ...
            System.out.println("Error in yakuza.ini, start CreateINI.bat to re-make the file.");
